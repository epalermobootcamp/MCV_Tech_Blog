...
![Creating A Post](./assets/images/CreatePost.png)

![Viewing A Post](./assets/images/ViewingPost.png)
...
A link to the [code](https://github.com/epalermobootcamp/MCV_Tech_Blog):

```
https://github.com/epalermobootcamp/MCV_Tech_Blog
```
